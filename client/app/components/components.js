...
ComponentsModule.controller('MyCtrl', ($scope) => {
       $scope.tabName = "tab1";
       $scope.actionList = ["actionOne", "actionTwo"];
       $scope.conditionList = ["conditionOne", "conditionTwo"];
       $scope.symptomList = ["symptomOne", "symptomTwo"];
...
ComponentsModule.directive('uiOnDrop', [
       '$parse',
       '$rootScope',
